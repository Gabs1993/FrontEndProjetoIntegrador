package com.blog.pessoal.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("com.blog.pessoal.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			...
			.licenseUrl("https://github.com/FehGusto")
			.contact(contact())
			.build();
	...
	private static Contact contact() {
		return new Contact("Felipe Augusto",
				"https://github.com/FehGusto",
				"felipe.santos.ofic@gmail.com");
